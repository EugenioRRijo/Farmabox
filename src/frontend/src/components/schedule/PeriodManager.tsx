  ...
  return (
    <div className="flex items-center justify-between bg-blue-50 p-4 rounded-lg border border-blue-100 mb-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-sm text-blue-600 font-medium uppercase tracking-wide">Periodo Académico</p>
          <h2 className="text-2xl font-bold text-gray-900">{currentPeriod}</h2>
        </div>
      </div>
      ...
      {onChange && (
        <button 
          className="px-4 py-2 text-sm font-medium text-blue-600 hover:bg-blue-100 rounded-md transition-colors"
